...
import { getStarship } from '../api/spacex'
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="hero-specs">
              {[
                { label: 'HEIGHT',        value: `${starship?.height?.meters}m / ${starship?.height?.feet}ft` },
                { label: 'DIAMETER',      value: `${starship?.diameter?.meters}m / ${starship?.diameter?.feet}ft` },
                { label: 'PAYLOAD — LEO', value: leoPayload ? `${leoPayload.toLocaleString()} kg` : 'N/A' },
